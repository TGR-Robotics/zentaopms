...
$defaultBug = array('module' => $moduleID, 'project' => $projectID, 'execution' => $executionID, 'openedBuild' => '', 'pri' => 3, 'severity' => 3);
...
$items[] = array('name' => 'openedBuild', 'label' => $lang->bug->openedBuild, 'control' => 'picker', 'items' => $builds, 'value' => '', 'multiple' => true, 'width' => '200px', 'required' => true, 'ditto' => true);
